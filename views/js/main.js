...
var resizePizzas = function(size) {
  ...
  // Refactor: Create var pizzaSizeLabel to avoid code repetition
  //           Remove unneeded inner function
  var pizzaSizeLabel = 'No Such Pizza';
  switch(size) {
    case '1':
  ...
  document.querySelector('#pizzaSize').innerHTML = pizzaSizeLabel;

  // Iterates through pizza elements on the page and changes their widths
  // Refactor: Create var pizzaContainers to reduce the number of queries
  //           Faster way to compute new pizza size.
  //           Remove unneeded inner function
...
//A global variable to store the moving pizzas
...
function createPizzas() {
  ...
  rovingPizzas.forEach(function(p){movingPizzasDiv.removeChild(p)});
  rovingPizzas = [];
...
// Generates the sliding pizzas when the page is resized.
